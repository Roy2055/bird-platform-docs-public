...
This repository contains the public architecture and product documentation for **Bird Platform**, a mobile bird identification and community platform built with:
...
The goal of this repository is to provide a clear view of the architectural thinking, platform responsibilities, and delivery approach behind Bird Platform. It is designed to show how the mobile app, backend services, media workflows, moderation model, and deployment approach fit together as part of a coherent product.
